...
There's a whole section about this in the [time zones documentation](/luxon/zones#math-across-dsts). But here's a quick example (Spring Forward is early on March 12 in my time zone):
