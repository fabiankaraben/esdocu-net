...
Please see the [install guide](/luxon#install-guide) for instructions on making sure your platform has access to the Intl APIs and the ICU data to power it. This especially important for Node, which doesn't ship with ICU data by default.
...
You can [parse](/luxon/parsing) localized strings:
