...
Bootstrap es mantenido por un [pequeño equipo de desarrolladores](https://github.com/orgs/twbs/people) en GitHub. Buscamos activamente hacer crecer este equipo y nos encantaría saber de ti si estás entusiasmado con CSS a escala, escribir y mantener complementos [JavaScript](https://esdocu.dev/javascript) básicos y mejorar los procesos de creación de herramientas para el código frontend.
