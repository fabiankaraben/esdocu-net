...
**Nuevo marcado en v5.3.0:** Hemos dejado de utilizar la estructura HTML anterior para las barras de progreso y la reemplazamos por una más accesible. La estructura anterior seguirá funcionando hasta la v6. [Mira los cambios en nuestra guía de migración.](/docs/5.3/migration/#improved-markup-for-progress-bars)
</Callout>
...
Tamaño de barra [#bar-sizing]
------------------------------

### Ancho [#width]

Bootstrap proporciona un puñado de [utilidades para configurar el ancho](/docs/5.3/utilities/sizing/). Dependiendo de tus necesidades, estos pueden ayudarte a configurar rápidamente el ancho de la `.progress-bar`.
...
Si agregas etiquetas a las barras de progreso con un color de fondo personalizado, asegúrate de establecer también un [color del texto](/docs/5.3/utilities/colors/#colors), para que las etiquetas sigan siendo legibles y tengan suficiente contraste.
...
Como alternativa, puedes usar las nuevas clases auxiliares combinadas [color y fondo](/docs/5.3/helpers/color-background/).
...
Rayas animadas [#animated-stripes]
-----------------------------------
