...
El acordeón usa [collapse](/docs/5.3/components/collapse/) internamente para hacerlo plegable. Para representar un acordeón expandido, agrega la clase `.open` en `.accordion`.
...
Lee la [sección de accesibilidad de collapse](/docs/5.3/components/collapse/#accessibility) para obtener más información.
