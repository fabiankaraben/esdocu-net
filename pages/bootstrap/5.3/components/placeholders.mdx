...
Los marcadores de posición se pueden utilizar para mejorar la experiencia de tu aplicación. Están creados únicamente con HTML y CSS, lo que significa que no necesitas [JavaScript](https://esdocu.dev/javascript) para crearlos. Sin embargo, necesitarás algo de [JavaScript](https://esdocu.dev/javascript) personalizado para alternar su visibilidad. Su apariencia, color y tamaño se pueden personalizar fácilmente con nuestras clases de utilidades.
