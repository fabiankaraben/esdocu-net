...
Estas clases también se pueden agregar a grupos de enlaces, como alternativa al [`.nav` componentes de navegación](/docs/5.3/components/navs-tabs/).
...
Combina botones de casilla de verificación y radio con forma de [botones de alternancia](/docs/5.3/forms/checks-radios/) en un grupo de botones de apariencia perfecta.
