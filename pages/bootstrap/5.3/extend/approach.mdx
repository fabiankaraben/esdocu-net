---
title: Acercarse · Bootstrap en Español v5.3
...
* Siempre que sea posible, prefiere una implementación HTML y CSS a [JavaScript](https://esdocu.dev/javascript)
...
Obtén más información sobre esto en nuestra [`z-index` página de diseño](/docs/5.3/layout/z-index/).

HTML y CSS sobre JS [#html-and-css-over-js]
--------------------------------------------

Siempre que sea posible, preferimos escribir HTML y CSS en lugar de [JavaScript](https://esdocu.dev/javascript). En general, HTML y CSS son más prolíficos y accesibles para más personas de todos los niveles de experiencia. HTML y CSS también son más rápidos en su navegador que [JavaScript](https://esdocu.dev/javascript), y su navegador generalmente le proporciona una gran cantidad de funciones.

Este principio es nuestra API [JavaScript](https://esdocu.dev/javascript) de primera clase que utiliza atributos `data` . No necesita escribir casi ningún [JavaScript](https://esdocu.dev/javascript) para utilizar nuestros complementos de [JavaScript](https://esdocu.dev/javascript); en su lugar, escriba HTML. Lee más sobre esto en [nuestra página de descripción general de JavaScript](/docs/5.3/getting-started/javascript/#data-attributes).
