...
Además de nuestras [utilidades de radio de borde](/docs/5.3/utilities/borders/), puedes usar `.img-thumbnail` para darle a una imagen una apariencia de borde redondeado de 1px.
...
Alinear imágenes con las [clases flotantes auxiliares](/docs/5.3/utilities/float/) o [clases de alineación de texto](/docs/5.3/utilities/text/#text-alignment). Las imágenes a nivel de `block` se pueden centrar usando [utilidad de margen `.mx-auto` (clase)](/docs/5.3/utilities/spacing/#horizontal-centering) .
