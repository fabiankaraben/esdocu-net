...
Bootstrap establece estilos básicos de visualización global, tipografía y enlaces. Cuando necesites más control, consulta las [clases de utilidades textuales](/docs/5.3/utilities/text/).

* Usa una [pila de fuentes nativas](/docs/5.3/content/reboot/#native-font-stack) que seleccione el mejor `font-family` para cada sistema operativo y dispositivo.
...
Cambia la alineación del texto, la transformación, el estilo, el peso, la altura de la línea, la decoración y el color con nuestras [utilidades de texto](/docs/5.3/utilities/text/) y [utilidades de color](/docs/5.3/utilities/colors/).
...
En Bootstrap 5, hemos habilitado tamaños de fuente responsive de forma predeterminada, lo que permite que el texto se escale de manera más natural en todos los tamaños de dispositivos y viewports. Echa un vistazo a la [página RFS](/docs/5.3/getting-started/rfs/) para descubrir cómo funciona.
...
Los elementos tipográficos diversos que se tratan aquí y en [Reboot](/docs/5.3/content/reboot/) también tienen variables dedicadas.
...
No hay mixins dedicados para tipografía, pero Bootstrap usa [Tamaño de fuente responsive (RFS)](/docs/5.3/getting-started/rfs/).
