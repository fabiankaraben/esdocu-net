...
[Ver Demo online](https://getbootstrap.com/docs/5.3/layout/grid/#example)
...
* **Nuestra grilla admite [seis puntos de interrupción responsive](/docs/5.3/layout/breakpoints/).** Los puntos de interrupción se basan en la `min-width` media queries, lo que significa que afectan ese punto de interrupción y todos los que están por encima de él (por ejemplo, `.col-sm-4` se aplica a `sm`, `md`, `lg`, `xl` y `xxl`). Esto significa que puedes controlar el tamaño y el comportamiento del contenedor y la columna según cada punto de interrupción.
...
* **Las filas son envoltorios para las columnas.** Cada columna tiene un `padding` horizontal (llamado gutter) para controlar el espacio entre ellas. Este `padding` luego se contrarresta en las filas con márgenes negativos para garantizar que el contenido de las columnas esté visualmente alineado hacia el lado izquierdo. Las filas también admiten clases modificadoras para [aplicar uniformemente el tamaño de las columnas](#row-columns) y [clases de gutter](/docs/5.3/layout/gutters/) para cambiar el espaciado de su contenido.
...
* **Los gutters también son responsive y personalizables.** [Las clases de gutters están disponibles](/docs/5.3/layout/gutters/) en todos los puntos de interrupción, con todos los mismos tamaños. como nuestro [espaciado de margin y padding](/docs/5.3/utilities/spacing/). Cambia los gutteres horizontales con clases `.gx-*`, los gutteres verticales con `.gy-*` o todos los gutteres con clases `.g-*`. `.g-0` también está disponible para eliminar gutters.
...
| Gutters personalizados | [Sí](/docs/5.3/layout/gutters/) |     |     |     |     |     |
| Anidable | [Sí](#nesting) |     |     |     |     |     |
| Orden de columnas | [Sí](/docs/5.3/layout/columns/#reordering) |     |     |     |     |     |
...
[Ver Demo online](https://getbootstrap.com/docs/5.3/layout/grid/#equal-width)
...
[Ver Demo online](https://getbootstrap.com/docs/5.3/layout/grid/#setting-one-column-width)
...
[Ver Demo online](https://getbootstrap.com/docs/5.3/layout/grid/#variable-width-content)
...
[Ver Demo online](https://getbootstrap.com/docs/5.3/layout/grid/#all-breakpoints)
...
[Ver Demo online](https://getbootstrap.com/docs/5.3/layout/grid/#stacked-to-horizontal)
...
[Ver Demo online](https://getbootstrap.com/docs/5.3/layout/grid/#mix-and-match)
...
[Ver Demo online](https://getbootstrap.com/docs/5.3/layout/grid/#row-columns)
...
[Ver Demo online](https://getbootstrap.com/docs/5.3/layout/grid/#nesting)
...
[Ver Demo online](https://getbootstrap.com/docs/5.3/layout/grid/#example-usage)
