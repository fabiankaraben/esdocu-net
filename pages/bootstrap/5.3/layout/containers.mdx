...
Velos en acción y compáralos en nuestro [ejemplo de cuadrícula](/docs/5.3/examples/grid/#containers).
...
Para obtener más información y ejemplos sobre cómo modificar nuestros mapas y variables de Sass, consulta la [sección de Sass de la documentación de Grid (cuadrícula)](/docs/5.3/layout/grid/#css).
