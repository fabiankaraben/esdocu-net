...
* **Los gutters comienzan en `1.5rem` (`24px`) de ancho.** Esto nos permite hacer coincidir nuestra cuadrícula con la escala de [espaciadores de margin y padding](/docs/5.3/utilities/spacing/).
...
[Ver Demo online](https://getbootstrap.com/docs/5.3/layout/gutters/#horizontal-gutters)
...
[Ver Demo online](https://getbootstrap.com/docs/5.3/layout/gutters/#vertical-gutters)
...
[Ver Demo online](https://getbootstrap.com/docs/5.3/layout/gutters/#horizontal--vertical-gutters)
...
Las clases de canal también se pueden agregar a [columnas de fila](/docs/5.3/layout/grid/#row-columns). En el siguiente ejemplo, utilizamos columnas de fila y clases de gutter responsive.

[Ver Demo online](https://getbootstrap.com/docs/5.3/layout/gutters/#row-columns-gutters)
...
[Ver demo online](https://getbootstrap.com/docs/5.3/layout/gutters/#no-gutters)
