---
title: Modos de color · Bootstrap en Español v5.3
...
[Ver la Demo online](https://getbootstrap.com/docs/5.3/customize/color-modes/#example)
...
Habilita el modo de color oscuro integrado en todo tu proyecto agregando el atributo `data-bs-theme="dark"` al elemento `<html>`. Esto aplicará el modo de color oscuro a todos los componentes y elementos, excepto aquellos con un atributo `data-bs-theme` específico aplicado. Aprovechando la [plantilla de inicio rápido](/docs/5.3/getting-started/introduction/#quick-start):
    ```html filename="HTML"
    <!doctype html>
...
[site/assets/scss/_content.scss](https://github.com/twbs/bootstrap/blob/v5.3.2/site/assets/scss/_content.scss)
    ...
    [Ver Demo online](https://getbootstrap.com/docs/5.3/customize/color-modes/#custom-color-modes)    
...
Aquí tienes un vistazo al [JavaScript](https://esdocu.dev/javascript) que lo impulsa. No dudes en inspeccionar nuestra propia barra de navegación de documentación para ver cómo se implementa utilizando HTML y CSS desde nuestros propios componentes. Se sugiere incluir [JavaScript](https://esdocu.dev/javascript) en la parte superior de su página para reducir el posible parpadeo de la pantalla durante la recarga de tu sitio. Ten en cuenta que si decides utilizar media queries para tus modos de color, es posible que debas modificar o eliminar tu [JavaScript](https://esdocu.dev/javascript) si prefiere un control implícito.
