---
title: Componentes · Bootstrap en Español v5.3
...
Consulta [nuestra documentación de mapas y bucles de Sass](/docs/5.3/customize/sass/#maps-and-loops) para saber cómo personalizar estos bucles y extender el enfoque de modificador de base de Bootstrap a tu propio código.
...
Para obtener más información y ejemplos sobre cómo modificar nuestros mapas y variables de Sass, consulta [la sección CSS de la documentación de Grid](/docs/5.3/layout/grid/#css).
...
[Ver Demo online](https://getbootstrap.com/docs/5.3/customize/components/#creating-your-own)
