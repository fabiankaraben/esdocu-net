...
Utiliza el [ayudante clearfix](/docs/5.3/helpers/clearfix/) en un elemento principal para borrar los elementos flotantes.
...
Las utilidades flotantes se declaran en nuestra API de utilidades en `scss/_utilities.scss`. [Aprende a utilizar la API de utilidades.](/docs/5.3/utilities/api/#using-the-api)
