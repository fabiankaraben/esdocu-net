...
Similar a las clases de color de texto contextual, establece el fondo de un elemento en cualquier clase contextual. Las utilidades de fondo background **no establecen `color`**, por lo que en algunos casos querrás usar `.text-*` [utilidades de color](/docs/5.3/utilities/colors/).
...
Las utilidades en segundo plano se declaran en nuestra API de utilidades en `scss/_utilities.scss`. [Aprende a utilizar la API de utilidades.](/docs/5.3/utilities/api/#using-the-api)
