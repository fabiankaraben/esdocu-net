...
Colorea texto con utilidades de color. Si deseas colorear enlaces, puedes utilizar las [`.link-*` (clases auxiliares)](/docs/5.3/helpers/colored-links/) que tienen los estados `:hover` y `:focus`.
...
Las utilidades de color se declaran en nuestra API de utilidades en `scss/_utilities.scss`. [Aprende a utilizar la API de utilidades.](/docs/5.3/utilities/api/#using-the-api)
