---
title: Contenidos · Bootstrap en Español v5.3
...
|`bootstrap-grid.css`<br/>`bootstrap-grid.rtl.css`<br/>`bootstrap-grid.min.css`<br/>`bootstrap-grid.rtl.min.css`|[Solo sistema de grilla](https://bootstrap-esdocu.com/docs/5.3/layout/grid/)|-|-|[Solo utilidades flex](https://bootstrap-esdocu.com/docs/5.3/utilities/flex/)|
...
|`bootstrap-reboot.css`<br/>`bootstrap-reboot.rtl.css`<br/>`bootstrap-reboot.min.css`<br/>`bootstrap-reboot.rtl.min.css`|-|[Solo Reboot](https://bootstrap-esdocu.com/docs/5.3/content/reboot/)|-|-|
