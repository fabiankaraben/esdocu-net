---
title: Bootstrap y Parcel · Bootstrap en Español v5.3
...
![](/bootstrap/5.3/assets/img/guides/bootstrap-parcel.png)
...
1.  **Rellena el archivo `src/index.html`.** Parcel necesita una página para renderizar, así que usamos nuestro `index.html` para configurar HTML básico, incluidos nuestros archivos CSS y [JavaScript](https://esdocu.dev/javascript).
    ```html filename="HTML"
    <!doctype html>
    <html lang="en">
        <head>
...
3.  **Y finalmente, podemos iniciar Parcel.** Desde la carpeta `my-project` en tu terminal, ejecuta el script npm recién agregado:
    ...
    ![Parcel dev server running](/bootstrap/5.3/assets/img/guides/parcel-dev-server.png)
...
3.  **¡Y listo! 🎉** Con el código fuente Sass y JS de Bootstrap completamente cargados, tu servidor de desarrollo local ahora debería verse así.
    ...
    ![Parcel dev server running with Bootstrap](/bootstrap/5.3/assets/img/guides/parcel-dev-server-bootstrap.png)
