---
title: RFS · Bootstrap en Español v5.3
...
En este ejemplo, utilizamos uno de los [mixins de puntos de interrupción responsive](/docs/5.3/layout/breakpoints/) integrados en Bootstrap para aplicar solo estilo debajo del punto de interrupción `lg`.
    ```css filename="CSS"
    .selector {
