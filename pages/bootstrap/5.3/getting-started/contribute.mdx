---
title: Contribuir · Bootstrap en Español v5.3
...
| Tarea | Descripción |
| --- | --- |
| `npm start` | Compila CSS y [JavaScript](https://esdocu.dev/javascript), crea la documentación e inicia un servidor local. |
