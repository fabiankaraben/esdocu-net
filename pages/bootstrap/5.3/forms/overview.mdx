...
|<span className="mx-16">Tópico</span>|Descripción|
|---|---|
|[**Control de formularios**](https://getbootstrap.com/../form-control)|Diseñar entradas de texto y áreas de texto con soporte para múltiples estados.|
|[**Select**](https://getbootstrap.com/../select)|Mejora los elementos de selección predeterminados del navegador con una apariencia inicial personalizada.|
|[**Checks y radios**](https://getbootstrap.com/../checks-radios)|Usa nuestros botones de opción y casillas de verificación personalizados en los formularios para seleccionar opciones de entrada.|
|[**Rango**](https://getbootstrap.com/../range)|Reemplaza las entradas del rango predeterminado del navegador con nuestra versión personalizada.|
|[**Grupo de entrada**](https://getbootstrap.com/../input-group)|Adjunta etiquetas y botones a tus entradas para aumentar el valor semántico.|
|[**Etiquetas flotantes**](https://getbootstrap.com/../floating-labels)|Crea etiquetas de formulario bellamente simples que floten sobre tus campos de entrada.|
|[**Layout**](https://getbootstrap.com/../layout)|Crea diseños en línea, horizontales o complejos basados en cuadrículas con tus formularios.|
|[**Validación**](https://getbootstrap.com/../validation)|Valida tus formularios con comportamientos y estilos de validación personalizados o nativos.|

Descripción general [#overview]
--------------------------------

Los controles de formulario de Bootstrap amplían [nuestros estilos de formulario reiniciados (Reboot)](/docs/5.3/content/reboot/#forms) con clases. Utiliza estas clases para optar por sus pantallas personalizadas y obtener una representación más consistente en todos los navegadores y dispositivos.
...
`$input-btn-*` son variables globales compartidas entre nuestros [botones](/docs/5.3/components/buttons/) y nuestros componentes de formulario. Los encontrará frecuentemente reasignados como valores a otras variables específicas de componentes.
