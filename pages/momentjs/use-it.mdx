...
Para utilizar Moment.js en [Meteor](https://www.meteor.com) utilizando el paquete disponible en [Atmosphere](https://atmospherejs.com), específicamente el paquete [momentjs:moment](https://atmospherejs.com/momentjs/moment). La instalación se realiza con el siguiente comando:
