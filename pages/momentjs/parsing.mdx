...
### Fichas relacionadas con el año de la era
...
## Cadena + Formatos [#string-formats]
...
## Timestamp de Unix (milisegundos) [#unix-timestamp-milliseconds]
...
## Timestamp de Unix (segundos) [#unix-timestamp]
...
## ASP.NET JSON Date [#asp-net-json-date]
